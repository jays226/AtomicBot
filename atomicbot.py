try:
  ...
  async def on_message(message):
      ...
      try:
        ...
        if(args[0] == '+send_update' and message.author.id == 695721540569923655):
          print(command)
  ...
  #TOKENS
  bot.run('ODI5MDUwMjAxNjQ4OTIyNjQ1.YGyfKw.0WdWJzlE5brojBRPF4SRVeLPaLk')
  # bot.run('ODMyMjYzNjcyODQzMDc1NjE0.YHhP8g.-XaEozpPh2QwZVQJSUkL0fsfS3I') # TEST TOKEN
except Exception as pirxcy:
  print(pirxcy)
